...
def setup_default_alphabet():
    ...
    initial_default_alphabet = "air bat cap drum each fine gust harp ink jane kick look made near ox pit quench red sun trap urge vest whale plex yank zip".split()
